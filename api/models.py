...
class TelemetryEvent(models.Model):
	...
	player =  models.ForeignKey('Player', on_delete=models.CASCADE, blank=True, null=True)
	killer_x_cord = models.FloatField(blank=True, null=True) 
	killer_y_cord = models.FloatField(blank=True, null=True) 
	victim_x_cord = models.FloatField(blank=True, null=True) 
	victim_y_cord = models.FloatField(blank=True, null=True) 
